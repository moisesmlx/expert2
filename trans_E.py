...
class Trans_E:
    def __init__(self, n_cifra, original, mudado, text_area, id=None):
        ...
        def t_E(self):
            if str(n_cifra) != '':
                try:
                    ...
                    #B
                    if original.upper() == 'E' and mudado.upper() == 'A':
                    ...
                    if original.upper() == 'E' and mudado.upper() == 'B':
                        original_cifra = escala.B
                        sub = escala.C
                   
                    if original.upper() == 'E' and mudado.upper() == 'C':
                        original_cifra = escala.B
                        sub = escala.Cst
                    ...
                    if original.upper() == 'E' and mudado.upper() == 'D':
                        original_cifra = escala.B
                        sub = escala.Dst
                    ...
                    if original.upper() == 'E' and mudado.upper() == 'F':
                        original_cifra = escala.B
                        sub = escala.F
                    ...
                    if original.upper() == 'E' and mudado.upper() == 'G':
                        original_cifra = escala.B
                        sub = escala.G
                        ...
                        for i in range(len(te)):
                            ...
                            if confere:
                                ...
                                for x in range(len(original_cifra)):
                                    ...
                                    elif original.upper() == 'E' and mudado.upper() == 'A#':
                                    ...
                                    elif original.upper() == 'E' and mudado.upper() == 'B':
                                    ...
                                    elif original.upper() == 'E' and mudado.upper() == 'C':
                                    ...
                                    elif original.upper() == 'E' and mudado.upper() == 'D':
                                    ...
                                    elif original.upper() == 'E' and mudado.upper() == 'F':
                                    ...
                                    elif original.upper() == 'E' and mudado.upper() == 'G':
        ...
        threading.Thread(target=t_E(self)).start()
